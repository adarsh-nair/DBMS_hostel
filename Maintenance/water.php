...
//	$date = Date("Y-m-d");
	$date = '2017-09-05';
	$furni = 'SELECT `Date_def`,`Hostelite_ID`, h.`Name`, h.`Room_No`,`Contact`, `Water` FROM `Hostelite` as h, `Room` as r WHERE r.`Room_No` = h.`Room_No` AND `Date_def` = \''.$date.'\' AND `Water` = \'Y\';';
